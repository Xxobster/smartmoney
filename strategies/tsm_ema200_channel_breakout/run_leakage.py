...
from strategies.tsm_ema200_channel_breakout.build_features import build_features
...
def main() -> None:
    ...
    (ROOT / "strategies" / "tsm_ema200_channel_breakout" / "LEAKAGE.md").write_text(
        f"# Leakage — tsm_ema200_channel_breakout\n\n- **ok:** `{summary['ok']}`\n\n```\n{summary['summary']}\n```\n",
        encoding="utf-8",
    )
