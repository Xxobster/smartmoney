...
from strategies.tsm_ema20_200.build_features import build_features


def main() -> None:
    df = load_ohlcv(research_db(), "BTCUSDT", "1d")
    out_dir = ROOT / "artifacts" / "reports" / "tsm_ema20_200"
    out_dir.mkdir(parents=True, exist_ok=True)
    report = run_leakage_audit(
        ohlcv=df, build_features=build_features, interval="1d",
