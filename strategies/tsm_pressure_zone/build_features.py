...
from strategies.tsm_pressure_zone.signals import build_signal_frame
...
def build_features(ohlcv: pd.DataFrame, *, interval: str = "1h") -> pd.DataFrame:
    ...
    # Exclude zone geometry / stops from leakage matrix (path labels).
    keep = ["ts_ms", "open", "high", "low", "close", "ema50", "long_signal", "short_signal"]
