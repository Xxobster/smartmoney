"""Leakage audit for RSI momentum + Fib builder."""
...
from strategies.tsm_rsi_momentum_fib.build_features import build_features
...
def main() -> None:
    ...
    (ROOT / "strategies" / "tsm_rsi_momentum_fib" / "LEAKAGE.md").write_text(
        f"# Leakage — tsm_rsi_momentum_fib\n\n- **ok:** `{summary['ok']}`\n\n```\n{summary['summary']}\n```\n",
        encoding="utf-8",
    )
